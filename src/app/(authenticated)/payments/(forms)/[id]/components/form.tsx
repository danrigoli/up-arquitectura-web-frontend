...
export function EditPaymentForm({ payment, categories, companies, onSave, loading }: Readonly<EditPaymentFormProps>) {
    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
        ...
        <Button type="submit" className="w-full" disabled={loading}>
          {loading ? <LoaderCircle className='w-5 h-5 animate-spin' /> : "Update Payment"}
        </Button>
      </form>
    </Form>
  )
